...
namespace OpenDKPShared.Helpers
{
    ...
    public class RaidHelper
    {
        ...
        public static void InsertRaidItems(
            OpenDkpContext pDBContext,
            string pClientId,
            dynamic pModel,
            Dictionary<string, Characters> pCharacterModels
        )
        {
        ...
        /// <returns></returns>
        public static Dictionary<string, Characters> GetCharacterModels(
            OpenDkpContext pDBContext,
            string pClientId,
            dynamic pModel
        )
        {
            ...
            foreach (var vItem in pModel.Items)
            {
                ...
                if (!vReturnModel.ContainsKey(vCharacterName.ToLower()))
                    vReturnModel.Add(
                        vCharacterName.ToLower(),
                        CharacterHelper.CreateCharacterIfNeeded(
                            pDBContext,
                            pClientId,
                            vCharacterName
                        )
        ...
        public static void InsertRaidTicks(
            OpenDkpContext pDBContext,
            string pClientId,
            dynamic pModel,
            Dictionary<string, Characters> pCharacterModels
        ...
        {
            Raids vResult;
            vResult = pDBContext.Raids.FirstOrDefault<Raids>(x =>
                x.ClientId.Equals(pClientId) && x.IdRaid == pRaidId
            );
            if (vResult != null)
            {
