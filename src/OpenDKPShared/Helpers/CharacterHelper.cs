...
namespace OpenDKPShared.Helpers
{
    public class CharacterHelper
    {
        ...
        /// <returns></returns>
        public static Characters CreateCharacterIfNeeded(
            OpenDkpContext pDBContext,
            string pClientId,
            string pCharacterName
        )
        {
            Characters vCharacterModel = pDBContext.Characters.FirstOrDefault(x =>
        ...
        /// <returns></returns>
        public static Characters GetCharacterByName(
            OpenDkpContext pDBContext,
            string pClientId,
            string pCharacterName
        )
